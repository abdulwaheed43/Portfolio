...
//   return (
//     <div className="text-center px-5 sm:px-8 md:px-10 lg:px-20 pt-24 md:pt-32">
...
//           width={128}
//           height={128}
//           className="w-24 sm:w-28 md:w-32 lg:w-36 h-auto rounded-full"
//         />
//       </motion.div>

//       {/* Intro */}
//       <motion.h3 className="flex items-center justify-center gap-2 text-lg sm:text-xl md:text-2xl mt-4">
//         I am Abdul Waheed
//         <Image src={assets.hand_icon} alt="hand" width={20} height={20} />
//       </motion.h3>

//       {/* Title */}
//       <motion.h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[60px] mt-4 leading-tight">
//         MERN Stack Developer & Problem Solver
//       </motion.h1>

//       {/* Desc */}
//       <motion.p className="max-w-2xl mx-auto mt-4 px-2 text-sm sm:text-base">
//         A MERN stack developer specializing in building full-stack web applications.
//       </motion.p>

//       {/* Buttons */}
//       <motion.div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6 mb-14 w-full">

//         <a
//           href="#contact"
//           className={`w-full sm:w-auto flex justify-center items-center gap-2 px-8 py-3 rounded-full ${
...
//           download
//           className="w-full sm:w-auto flex justify-center items-center gap-2 px-8 py-3 border border-gray-500 rounded-full"
//         >
//           My Resume
//         </a>
